...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Rotate_Joint_Update_m29F900D45E05A59D366E0CD8AED0200CE3FB7C36 (Rotate_Joint_tF195AC12E7522A5BD3DEEE37F276787DC459C22A* __this, const RuntimeMethod* method) 
{
	...
	{
		// transform.Rotate(0, positions[num] + offset - transform.rotation.eulerAngles.y, 0, Space.Self);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_4;
		L_4 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C* L_5 = __this->___positions_8;
		int32_t L_6 = __this->___num_7;
		NullCheck(L_5);
		int32_t L_7 = L_6;
		float L_8 = (L_5)->GetAt(static_cast<il2cpp_array_size_t>(L_7));
		float L_9 = __this->___offset_5;
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_10;
		L_10 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		NullCheck(L_10);
		...
		NullCheck(L_4);
		Transform_Rotate_mE12DB27208410BB7090FA117D53DBEBBC0A36B30(L_4, (0.0f), ((float)il2cpp_codegen_subtract(((float)il2cpp_codegen_add(L_8, L_9)), L_13)), (0.0f), 1, NULL);
		return;
	}
...
IL_0064:
	{
		// else if(axis == 'x'){
		Il2CppChar L_14 = __this->___axis_6;
		if ((!(((uint32_t)L_14) == ((uint32_t)((int32_t)120)))))
		{
			goto IL_00b2;
		}
	}
	{
		// transform.Rotate(positions[num] + offset - transform.rotation.eulerAngles.x, 0, 0, Space.Self);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_15;
		L_15 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C* L_16 = __this->___positions_8;
		int32_t L_17 = __this->___num_7;
		NullCheck(L_16);
		int32_t L_18 = L_17;
		float L_19 = (L_16)->GetAt(static_cast<il2cpp_array_size_t>(L_18));
		float L_20 = __this->___offset_5;
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_21;
		L_21 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		NullCheck(L_21);
		...
		NullCheck(L_15);
		Transform_Rotate_mE12DB27208410BB7090FA117D53DBEBBC0A36B30(L_15, ((float)il2cpp_codegen_subtract(((float)il2cpp_codegen_add(L_19, L_20)), L_24)), (0.0f), (0.0f), 1, NULL);
		return;
	}
...
IL_00b2:
	{
		// else if(axis == 'z'){
		Il2CppChar L_25 = __this->___axis_6;
		if ((!(((uint32_t)L_25) == ((uint32_t)((int32_t)122)))))
		{
			goto IL_00ff;
		}
	}
	{
		// transform.Rotate(0, 0, positions[num] + offset - transform.rotation.eulerAngles.z, Space.Self);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_26;
		L_26 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C* L_27 = __this->___positions_8;
		int32_t L_28 = __this->___num_7;
		NullCheck(L_27);
		int32_t L_29 = L_28;
		float L_30 = (L_27)->GetAt(static_cast<il2cpp_array_size_t>(L_29));
		float L_31 = __this->___offset_5;
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_32;
		L_32 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		NullCheck(L_32);
		...
		NullCheck(L_26);
		Transform_Rotate_mE12DB27208410BB7090FA117D53DBEBBC0A36B30(L_26, (0.0f), (0.0f), ((float)il2cpp_codegen_subtract(((float)il2cpp_codegen_add(L_30, L_31)), L_35)), 1, NULL);
	}
